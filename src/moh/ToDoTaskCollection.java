...
public class ToDoTaskCollection implements Serializable {
    ...
    public void addNewTask() throws Exception {
        ...
        taskList.add(task);
        fileWriter.write(task.getProjectName() + "," + task.getTaskList() + ", " + task.getDueDate().toString() + ", " + task.getStatus() + "\n");
        fileWriter.close();
    }
     ...
     */
    public ToDoTaskList editTask(String searchTaskName, String newTaskName) {
